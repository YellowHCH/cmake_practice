...
alias vi='/home/chenhui.huang/software/vim_install_dir/bin/vim'
alias vim='/home/chenhui.huang/software/vim_install_dir/bin/vim'
...
# login cmd
container_name='chenhui.huang.for_dev.ubuntu20.04-cuda11.4.4-cudnn8.2-v2.0'
alias gochh='docker exec -it --user chenhui.huang chenhui.huang.for_dev.ubuntu20.04-cuda11.4.4-cudnn8.2-v2.0 bash'
alias goroot='docker exec -it --user root chenhui.huang.for_dev.ubuntu20.04-cuda11.4.4-cudnn8.2-v2.0  bash'
